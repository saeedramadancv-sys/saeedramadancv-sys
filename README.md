...
<p align="center">
  <b>Computer Engineer</b> — Full-Stack Web Development &amp; Networking
</p>
...
B.Sc. in Computer Engineering from the **University of Jordan**. I build web apps with **ASP.NET Core** and **JavaScript**, and I design and troubleshoot **Cisco** router &amp; switch topologies — checking one layer at a time instead of guessing where the fault is.
...
![Cisco IOS CLI](https://img.shields.io/badge/-Cisco%20IOS%20CLI-1BA0D7?style=flat-square&logo=cisco&logoColor=white)
...
**🎮 [Dota 2 SkinChanger — Community Website](https://dota2-arcanavault.pages.dev/)** · _Cloudflare Pages_
Bilingual (Arabic RTL / English) landing page deployed on Cloudflare Pages.
